...
module new_spi_tb ();
    ...
    /* Test */
    initial begin
        $dumpfile("new_spi_tb.vcd");
        $dumpvars(0, new_spi_tb);
        #20
        ...
        write(SPI_BASEADDR + 32'h0C, {24'd0, 8'h30}); /* send 0x30 */
        write(SPI_BASEADDR + 32'h0C, {24'd0, 8'h40}); /* send 0x40 */
        write(SPI_BASEADDR + 32'h0C, {24'd0, 8'h50}); /* send 0x50 */
        write(SPI_BASEADDR + 32'h0C, {24'd0, 8'h60}); /* send 0x60 */
        write(SPI_BASEADDR + 32'h0C, {24'd0, 8'h70}); /* send 0x70 */
        #600
